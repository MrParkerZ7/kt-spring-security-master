package com.park.spring.security.mongo.kt.securityjwtmongo.model
...
class JwtAuthenticationToken(var token: String) : UsernamePasswordAuthenticationToken(null, null) {
    override fun getCredentials(): Any? = null // TODO: Have to do more for real project
    override fun getPrincipal(): Any? = null // TODO: Have to do more for real project
}
